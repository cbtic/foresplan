<title>Sistema de SIPREFI</title>
...
function fn_save_responsable(){
    
	var _token = $('#_token').val();
	var id_valorizacion = $('#id_valorizacion').val();
	var observacion_responsable = $('#observacion_responsable').val();
	//var estado = $('#estado_dudoso').val();
	//var id_moneda = $('#id_moneda_modal').val();
	
	var msg = "";
    //if(id_persona == "")msg += "Debe ingresar el numero de documento <br>";
    if(observacion_responsable==""){msg+="Debe ingresar una Observacion<br>";}
	...
	/*
    $.ajax({
			url: "/adelanto/send_adelanto",
            type: "POST",
            data : {_token:_token,observacion_responsable:observacion_responsable},
	...
	*/
	...
	$.ajax({
			url: "/ingreso/send_responsable",
            type: "POST",
            data : {_token:_token,id_valorizacion:id_valorizacion,observacion_responsable:observacion_responsable},
            success: function (result) {
					$('.loader').hide();
					$('#openOverlayOpc').modal('hide');
					//document.frmValorizacion.submit();
					location.href='/pesaje/ver_pesaje_estacionamiento/'+id_valorizacion;
            }
    });
    ...
    <div>
		...
		<div class="card">
			...
			<div class="card-header" style="padding:5px!important;padding-left:20px!important">
				Observaci&oacute;n Responsable
			</div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px">
					...
					<input type="hidden" name="id_valorizacion" id="id_valorizacion" value="<?php echo $id?>">
					<!--<input type="hidden" name="estado_dudoso" id="estado_dudoso" value="<?php //echo $estado?>">-->
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea id="observacion_responsable" name="observacion_responsable" class="form-control form-control-sm"></textarea>
							</div>
						</div>
					...
					<div style="margin-top:10px" class="row form-group">
						<div class="col-sm-12 controls">
							<div class="btn-group btn-group-sm" role="group" aria-label="Log Viewer Actions" style="float:right">
								...
								<input class="btn btn-sm btn-success" value="Guardar" type="button" id="btnGuardar" onClick="fn_save_responsable()">
