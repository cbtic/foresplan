...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
        <li class="breadcrumb-item text-primary">Inicio</li>
            <li class="breadcrumb-item active">Consulta de Cliente Usuario</li>
        </li>
    </ol>
@endsection
    ...
    <div class="justify-content-center">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Consultar Cliente - Usuario <!--<small class="text-muted">Usuarios activos</small>-->
                    </h4>
                </div><!--col-->
            </div>
        ...
        <div class="col col-sm-12 align-self-center">
            ...
            <div class="card">
				...
				<form class="form-horizontal" method="post" action="" id="frmClienteUsuario" autocomplete="off">
				<input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
				
				<div class="row" style="padding:20px 20px 0px 20px;">
				
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" style="padding-left:0px;margin-left:0px;">
                        <select name="cliente_bus" id="cliente_bus" class="form-control form-control-sm">
                ...
                <div class="card-body">				
                    ...
                    <table id="tblClienteUsuario" class="table table-hover table-sm">
                        <thead>
...
<script src="{{ asset('js/clienteUsuario.js') }}"></script>
