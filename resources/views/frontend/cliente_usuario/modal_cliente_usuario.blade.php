...
function fn_save_cliente_usuario() {
	...
	if(cliente == "")msg += "Debe ingresar el Cliente <br>";
	if(usuario == ""){msg += "Debe ingresar el Usuario <br>";}
	...
	if(msg!=""){
		...
		$.ajax({
			url: "/cliente_usuario/send_cliente_user",
			type: "POST",
			data : $('#frmClienteUsuario').serialize(),
	...
	<div>
		...
		<div class="justify-content-center">
			...
			<div class="card">
				...
				<div class="card-body">
					<form method="post" action="#" id="frmClienteUsuario" name="frmClienteUsuario">
					<div class="row">
						<!--aaaa-->
								...
								<div class="row">
									<div class="col-lg-4">
										<div class="form-group">
											<label class="control-label form-control-sm">Cliente</label>
											<select name="cliente" id="cliente" class="form-control form-control-sm">
												<option value="">Seleccionar</option>
												<?php foreach($cliente as $row){?>
													<option value="<?php echo $row->id?>" <?php if($row->id==$cliente_user->cliente_id)echo "selected='selected'"?> ><?php echo $row->denominacion?></option>
												<?php }?>
											</select>
										</div>
									</div>
										...
										<div class="form-group">
											...
											<select name="usuario" id="usuario" class="form-control form-control-sm">
												...
												<?php foreach($usuario as $row){?>
													<option value="<?php echo $row->id?>" <?php if($row->id==$cliente_user->user_id)echo "selected='selected'"?> ><?php echo $row->name?></option>
												<?php }?>
											</select>
										</div>
									</div>
								...
								<div style="margin-top:15px" class="form-group">
									<div class="col-sm-12 controls">
										<div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
											<a href="javascript:void(0)" onClick="fn_save_cliente_usuario()" class="btn btn-sm btn-success">Guardar</a>
										</div>
