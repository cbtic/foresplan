...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
        <li class="breadcrumb-item text-primary">Inicio</li>
            <li class="breadcrumb-item active">Consulta Log Tarjeta Desactivada</li>
        </li>
    </ol>
@endsection
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Consulta Log Tarjeta Desactivada
                    </h4>
                </div><!--col-->
            </div>
        ...
        <div class="col col-sm-12 align-self-center">
            ...
            <div class="card">
                <div class="card-header">
                    <strong>
                        Lista de Log Tarjeta Desactivada
                    </strong>
                </div><!--card-header-->
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
						<select name="id_panel" id="id_panel" class="form-control form-control-sm">
							<option value="BRIE223760052" selected = 'selected'>Panel 01</option>
							<option value="AJYX224460021">Panel 02</option>
						</select>
					</div>
					...
					<div class="col-lg-1 col-md-1 col-sm-12 col-xs-12" style="padding-left:0px;margin-left:0px;padding-right:0px;margin-right:0px">
						<input class="form-control form-control-sm" id="fecha_ini" name="fecha_ini" value="<?php echo date("d-m-Y",strtotime($fecha_actual."- 1 days"));?>" placeholder="Fecha Inicio Desde">
					</div>
...
@push('after-scripts')
{!! script(asset('js/tarjetaLogAccesoLista.js')) !!}
@endpush
