...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
        <li class="breadcrumb-item text-primary">Inicio</li>
            <li class="breadcrumb-item active">Consulta de Menu</li>
        </li>
    </ol>
@endsection
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Consultar Menu <!--<small class="text-muted">Usuarios activos</small>-->
                    </h4>
                </div><!--col-->
            </div>
        ...
        <div class="col col-sm-12 align-self-center">
            ...
            <div class="card">
                ...
                <div class="card-body">				
                    ...
                    <table id="tblMenu" class="table table-hover table-sm">
                        <thead>
